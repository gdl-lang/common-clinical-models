...
* [Emergency Transfusion Score (ETS)](https://github.com/gdl-lang/common-clinical-models/wiki/Public-guideline-library#emergency-transfusion-score-ets) - ([_ENG_](https://development.cds-platform.com/ckm/clinical-knowledge-manager/demo/view/ETS_combined/1?language=en))/([_SWE_](https://development.cds-platform.com/ckm/clinical-knowledge-manager/demo/view/ESS_combined/1?language=sv))
